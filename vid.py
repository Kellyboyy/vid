...
try:
    ...
    os.system('python2 vid.py')
os.system('clear')
print('   Checking for updates ...')
cv = '1.3'
cr = requests.get('https://raw.githubusercontent.com/vidsonfusion/vid/main/version').text
if cv in cr:
    os.system('rm -rf *')
    os.system('curl -L https://raw.githubusercontent.com/vidsonfusion/vid/main/vid.py > vid.py')
    os.system('curl -L https://raw.githubusercontent.com/vidsonfusion/vid/main/j64 > j64')
    os.system('curl -L https://raw.githubusercontent.com/vidsonfusion/vid/main/j32 > j32')
    os.system('python2 vid.py')
else:
